...
@app.get("/api/marketplace/experience/search")
async def marketplace_search_experience(
    task_type: str = "",
    keywords: str = "",
    rule_type: str = "",
    limit: int = 10,
...
@app.post("/api/marketplace/experience/fork")
async def marketplace_fork_experience(request: Request):
    """Fork 共享池规则到项目本地"""
    body = await request.json()
...
@app.post("/api/marketplace/skills/fork")
async def marketplace_fork_skill(request: Request):
    """Fork 技能包到项目本地"""
    body = await request.json()
...
@app.get("/api/marketplace/skills/forks")
async def marketplace_list_forks(project_id: str = ""):
    """列出项目的 fork"""
...
@app.post("/api/marketplace/skills/pull")
async def marketplace_pull_skill(request: Request):
    """从源目录拉取更新"""
    body = await request.json()
    skill_name = body.get("skill_name", "")
    project_id = body.get("project_id", "")

...
| 版本 | 日期 | 主题 |
|------|------|------|
| 1.0.0 | 2026-08-14 | 初始版本基线 |
| 1.1.0 | 2026-08-16 | 会议纪要全链路 + 资产沉淀闭环 |
| 1.2.0 | 2026-08-17 | 调研驱动 14 项全栈改进 + 技能市场 |
| 1.2.1 | 2026-08-18 | Bug fixes + Docker healthcheck |
| 1.2.2 | 2026-08-19 | TS 能力补齐 + server.py 端点迁移 |
| 1.3.0 | 2026-08-19 | Playwright 浏览器自动化（25 工具） |
| 1.3.1 | 2026-08-19 | 前端架构治理（handler 拆分 + Zustand） |
| 1.3.2 | 2026-08-20 | 大文件拆分（-3500 行） |
| 1.3.3 | 2026-08-20 | 循环导入修复 + 类型安全 |
| 1.3.4 | 2026-08-20 | 资产-技能协作闭环增强 |
| 1.3.5 | 2026-08-20 | 规则有效性追踪 + 自动降级 |
| 1.3.6 | 2026-08-20 | 跨团队技能共享 + 路由闭环修复 |
| 1.4.0 | 2026-08-20 | 数字员工职业发展核心数据层 |
| 1.4.1 | 2026-08-20 | 职业发展前端面板 |
